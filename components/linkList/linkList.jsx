...
export default function LinkList() {
  ...
  return (
    <section className='grid grid-cols-2 gap-2'>
      <a href='https://portal.konkuk.ac.kr/' className={btnStyle}>
        건국대학교포탈시스템
      </a>
      <a
      ...
      <a href='http://sw.konkuk.ac.kr/' className={btnStyle}>
        (구)소프트웨어학과
      </a>
      <a href='http://ce.konkuk.ac.kr/' className={btnStyle}>
        (구)컴퓨터공학과
      </a>
      <a href='https://library.konkuk.ac.kr/#/' className={btnStyle}>
        상허기념도서관
      </a>
      <a
